    ...
    def create_policy(self, policy: PolicyRule) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Failed to create policy. Status Code: {response.status_code}")
    ...
    def read_policy(self, policy_rule_uri: str) -> Optional[PolicyRule]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Failed to read policy. Status Code: {response.status_code}")
        except requests.exceptions.RequestException as e:
            print(f"Request failed: {e}")
        return None
    ...
    def update_policy(self, policy_rule_uri: str, updated_policy: PolicyRule) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Failed to update policy. Status Code: {response.status_code}")
        except requests.exceptions.RequestException as e:
            print(f"Request failed: {e}")
        return False
    ...
    def delete_policy(self, policy_rule_uri: str) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Failed to delete policy. Status Code: {response.status_code}")
        except requests.exceptions.RequestException as e:
            print(f"Request failed: {e}")
        return False
    ...
    def query_policies(self, query_filter: dict) -> List[PolicyRule]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"Failed to query policies. Status Code: {response.status_code}")
        except requests.exceptions.RequestException as e:
            print(f"Request failed: {e}")
        return []
