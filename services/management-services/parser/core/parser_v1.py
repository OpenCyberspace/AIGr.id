...
class Validators:
    ...
    def __call_validator(self, t: str, d, key: str, tmpl: dict):
    ...
    def bypass_any(self, data: dict, templ: dict):
        return True, "bypassed"

    def validate_i(self, data: dict, templ: dict):
        number = data['value']
    ...
    def validate_boolean(self, data: dict, templ: dict):
        flag = data['value']
        if type(flag) != bool:
    ...
    def validate_object(self, od: dict, templ: dict):
    ...
    def validate_references(self, data: dict, templ: dict):
    ...
    def validate_template(self, od: dict, templ: dict):
    ...
    def validate_string(self, od: dict, templ: dict):
    ...
    def validate_choices(self, data: dict, templ: dict):
        return True, "validation passed"

    def validate_array(self, data: dict, templ: dict):
        array = data['value']
        key = data['key']
...
def parse_vdag_input(input_data: dict):
...
class V1Parser:
    ...
    def create_validator_and_validate(self, spec):
    ...
    def validate_and_return_templates(self, spec):
