...
class Framedb(EmbeddedMongoModel) :
    ...
    cluster_name = fields.CharField(required = True)

    metadata = fields.MongoBaseField(required = False, default = {}, blank = True)
...
class FrameSourceMapping(MongoModel) :
    ...
    nodeTags = fields.ListField(field = fields.CharField(), required = True)
