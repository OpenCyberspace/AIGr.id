...
def execute_policy_request(policy_rule_uri, input_data, parameters=None):
    executor_id = os.getenv("POLICY_SYSTEM_EXECUTOR_ID")
    executor_host_url = os.getenv(
        "POLICY_EXECUTOR_HOST_URL", "http://localhost:7000")
...
class PolicyFunctionExecutor:
    def __init__(self, policy_rule_uri: str = None, parameters: dict = None, settings: dict = None, custom_class=None, mode="local"):
